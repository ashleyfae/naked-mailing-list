...
function nml_add_menu_pages() {
	...
	add_submenu_page( 'nml-newsletters', esc_html__( 'Reports', 'naked-mailing-list' ), esc_html__( 'Reports', 'naked-mailing-list' ), 'manage_options', 'nml-reports', 'nml_reports_page' );
