...
function nml_add_menu_pages() {
	...
	add_submenu_page( 'nml-newsletters', esc_html__( 'Post Notifications', 'naked-mailing-list' ), esc_html__( 'Post to Email', 'naked-mailing-list' ), 'manage_options', 'nml-notifications', 'nml_notifications_page' );
