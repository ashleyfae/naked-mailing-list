...
function nml_options_page() {
	...
	$registered_sections = nml_get_settings_tab_sections( $active_tab );
	...
	<div class="wrap">
		<h1 class="nav-tab-wrapper">
			<?php
			foreach ( nml_get_settings_tabs() as $tab_id => $tab_name ) {
				...
				// its own section.
				$this_tabs_sections = nml_get_settings_tab_sections( $tab_id );
		...
		<div id="tab_container">
			<form method="post" action="options.php">
				<table class="form-table">
					<?php
					settings_fields( 'nml_settings' );
					if ( 'main' === $section ) {
						do_action( 'nml_settings_tab_top', $active_tab );
					}
					do_action( 'nml_settings_tab_top' . $active_tab . '_' . $section );
					do_settings_sections( 'nml_settings_' . $active_tab . '_' . $section );
					do_action( 'nml_settings_tab_bottom' . $active_tab . '_' . $section );
					?>
				</table>
